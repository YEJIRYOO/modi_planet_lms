...
export const COURSES: Course[] = [
  ...
  { id: '3', title: '1942', description: '자이로로 조종하고 버튼으로 발사하는 비행 슈팅', type: 'HW_SW', level: 'elementary', goal: 'IMU·버튼으로 조종하는 슈팅 게임', modules: ['imu', 'button', 'motor_a'], project: { previewUrl: '/projects/1942/index.html', downloadUrl: '/projects/1942-standalone.zip', previewNote: '사이트에서 바로 실행됩니다. 연결된 IMU·버튼 또는 키보드·슬라이더로 조작하세요.', modiBridge: true } },
  { id: '4', title: 'Tilt Match', description: 'MODI LED 색과 같은 쪽으로 기울여 점수를 얻는 반응 게임', type: 'HW_SW', level: 'elementary', goal: 'LED 색 판별 + 기울기 반응 게임', modules: ['imu', 'led'], project: { previewUrl: '/projects/tilt-match/index.html', downloadUrl: '/projects/tilt-match-standalone.zip', previewNote: '사이트에서 바로 실행됩니다. IMU 또는 화면 슬라이더로 색 방향을 맞추세요.', modiBridge: true } },
  { id: '5', title: 'Loop Studio', description: '다이얼 또는 조이스틱으로 볼륨을 조절하고 버튼으로 재생하는 8칸 음악 시퀀서', type: 'HW_SW', level: 'middle', goal: 'MODI 스피커로 연주하는 시퀀서', modules: ['dial', 'button', 'speaker'], project: { previewUrl: '/projects/music-studio/index.html', downloadUrl: '/projects/music-studio-standalone.zip', previewNote: '사이트에서 패턴·템포·볼륨을 조절하고 연결한 MODI 스피커로 연주할 수 있습니다.', modiBridge: true } },
  { id: '6', title: 'Tilt & Click 연결 점검', description: '자이로를 기울이고 버튼을 눌러 HW+SW 연결을 한 번에 확인', type: 'HW_SW', level: 'elementary', goal: '자이로·버튼 실시간 입력 점검', modules: ['imu', 'button'] },
