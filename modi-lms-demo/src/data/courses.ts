...
export interface Course {
  ...
  // 정적 코스 팩 id. public/courses/<pack>/course.json 을 읽어 준비물·미리보기·관문을 채운다.
  // 백엔드 없이 수업이 돌아가야 하는 HW+SW 차시에서 쓴다.
  pack?: string;
}
...
export const COURSES: Course[] = [
  ...
  { id: '3', title: '스마트 화분', description: '센서로 식물 상태를 읽고 웹으로 보여주는 IoT', type: 'HW_SW', goal: '센서 + 웹 대시보드', modules: ['env', 'network', 'display'], plan: SAMPLE_PLAN_SMARTPOT },
  { id: '4', title: '1942 비행 조종', description: '자이로를 기울여 조종하고 버튼으로 발사하는 슈팅 게임', type: 'HW_SW', goal: '자이로 + 버튼으로 조종하는 게임', modules: ['imu', 'button', 'network'], pack: '1942' },
];
