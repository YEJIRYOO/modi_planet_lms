...
export const COURSES: Course[] = [
  ...
  { id: '4', title: 'Tilt Match', description: 'MODI LED 색과 같은 쪽으로 기울여 점수를 얻는 반응 게임', type: 'HW_SW', level: 'elementary', hidden: true, goal: 'LED 색 판별 + 기울기 반응 게임', modules: ['imu', 'led'], project: { previewUrl: '/projects/tilt-match/index.html', downloadUrl: '/projects/tilt-match-standalone.zip', previewNote: '사이트에서 바로 실행됩니다. IMU 또는 화면 슬라이더로 색 방향을 맞추세요.', modiBridge: true } },
